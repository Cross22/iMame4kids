...
//		if (CPU_AUDIO_OFF(temp_cpu)) continue;
        ...
        //(mg)
#define ALWAYS_INVINCIBLE
#ifdef ALWAYS_INVINCIBLE
        if (strstr(CheatTable[LoadedCheatTotal].name, "Invincibility") != NULL)
        {
            cheat_set_status (LoadedCheatTotal, 1);
        }
#endif
